...
$page_title = "My Sport Session Pro: Agenda et logiciel pour les coachs de Sport";
$page_description = "Découvrez la solution complète pour les coachs sportifs. Gérez vos réservations, optimisez votre emploi du temps et augmentez vos revenus grâce à un outil adapté à vos besoins.";
...
<body class="intern coach-landing">
        ...
        <div class="container">
            <div class="heroshot__content">
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <h1 class="h1-title left big">Vivez votre sport</h1>
                        <p class="p-text white">Libérez vos journées et développez votre business avec My Sport Session. Gagnez en visibilité et optimisez la gestion de vos réservations.</p>
                        <ul class="check-text">
                            <li class="p-text white" data-aos="fade-right" data-aos-delay="200" data-aos-duration="500">+ 10 000 réservations par mois</li>
                            <li class="p-text white" data-aos="fade-right" data-aos-delay="300" data-aos-duration="500">Sans engagement</li>
                            <li class="p-text white" data-aos="fade-right" data-aos-delay="400" data-aos-duration="500">Sans commission</li>
                        </ul>
                    </div>
                    <div class="col-lg-7 col-xl-5 align-self-center">
                        <article class="form" id="decouvrir-gratuitement">
                            <div class="container">
                                <div id="the-form">
                                    <h2 class="h2-title center">Vous êtes un coach sportif indépendant?</h2>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <h2 class="h2-title">Votre passion pour votre activité de coach sportif</h2>
                    <p class="p-text">Des heures de gagnées. De nouveaux clients. Une gestion de l’activité simplifiée. Voici la solution de gestion idéale pour les coachs sportifs.</p>
            ...
            <div class="row align-items-start justify-content-center justify-content-lg-between">
                <div class="col-lg-6 order-lg-0 order-1">
                    ...
                    <ul class="check-text my-4 my-lg-5">
                        <li class="p-text" data-aos="fade-right" data-aos-delay="200" data-aos-duration="500">Page vitrine de votre établissement</li>
    ...
    <section class="testimonials" id="testimonials">
        <div class="container">
            <h2 class="h2-title center mb-5">Rejoignez notre communauté de coach sportif</h2>
