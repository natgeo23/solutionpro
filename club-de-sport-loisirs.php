...
<body class="intern coach-landing">
        ...
        <div class="container">
            <div class="heroshot__content">
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <h1 class="h1-title left big">Le logiciel pensé pour les clubs de sport & loisirs.</h1>
                        <p class="p-text white">Libérez vos journées et la gestion de vos clients avec My Sport Session. Gagnez en visibilité, développez votre panier moyen et maximisez votre temps de remplissage.</p>
                        <ul class="check-text">
                            <li class="p-text white" data-aos="fade-right" data-aos-delay="200" data-aos-duration="500">Agenda connecté accessible par tous les membres du bureau de votre association </li>
                            <li class="p-text white" data-aos="fade-right" data-aos-delay="300" data-aos-duration="500">Optimisation de la gestion des plannings des animateurs et des responsables activités </li>
                    ...
                    <div class="col-lg-7 col-xl-5 align-self-center">
                        <article class="form" id="decouvrir-gratuitement">
                            <div class="container">
                                <div id="the-form">
                                    <h2 class="h2-title center">Vous êtes un club de sport & loisirs ?</h2>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <h2 class="h2-title">Une nouvelle vitrine pour votre club de sport & loisirs</h2>
                    <p class="p-text">Une gestion facilitée et simplifiée. Des heures de gagnées. Des nouveaux clients. Voici la plateforme de gestion idéale pour les clubs de sport & loisirs.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <ul class="check-text">
                                    ...
                                    <li class="p-text" data-aos="fade-right" data-aos-delay="300" data-aos-duration="500">Référencement sur la plateforme <a href="https://mysportsession.com" target="_blank">mysportsession.com</a> et celles de nos institutions* et partenaires. <span>*(Sous validation contractuelle)</span></li>
        ...
        <div class="container">
            <div class="row align-items-start justify-content-center justify-content-lg-between">
                <div class="col-lg-6 order-lg-0 order-1">
                    <h2 class="h2-title">Un nouveau moyen de développer votre clientèle en toute sérénité</h2>
                    <ul class="check-text my-4 my-lg-5">
                        <li class="p-text" data-aos="fade-right" data-aos-delay="200" data-aos-duration="500">Devenez plus visibles et plus accessibles auprès de ceux qui ne vous connaissent pas</li>
                        <li class="p-text" data-aos="fade-right" data-aos-delay="300" data-aos-duration="500">Convertissez-les en nouveaux clients grâce à une plateforme de réservation dédiée, sans engagement</li>
                        <li class="p-text" data-aos="fade-right" data-aos-delay="400" data-aos-duration="500">Minimisez les no-show</li>
                    </ul>
                    <p class="btn-wrapper"><a href="#decouvrir-gratuitement" class="btn_01">Découvrir gratuitement</a></p>
                </div>
                <div class="col-8 col-lg-5 order-lg-1 order-0">
                    <div class="info__box">
                        <div class="info__box-img-wrapper" data-aos="zoom-in" data-aos-duration="500">
                            <img src="src/assets/img/club-de-sport-loisirs/img-meilleure.png" alt="" class="info__box-img">
                        </div>
                        <h3 class="info__box-title">+ 100 fonctionnalités</h3>
                        <h4 class="info__box-text">de personnalisation de vos réservations </h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-lg-6 order-lg-0">
                    <h2 class="h2-title">Une gestion automatisée de votre agenda</h2>
                    <p class="p-text">Utilisation de l’agenda de manière synchronisée sur tous types d’appareils. <br>
                        Actualisations en temps réel. Facilité d’utilisation. Nous vous accompagnons dans la découverte et la gestion optimale de l’outil. </p>
                    <ul class="check-text my-4 my-lg-5">
    ...
    <section class="info">
        <div class="container">
            <h2 class="h2-title blue center mb-4 mb-lg-5">99% des réservations honorées</h2>
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                <div class="col-8 col-lg-5">
    ...
    <section class="info dark-bg py-5">
        <div class="container">
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                <div class="col-lg-6 order-lg-0 order-1">
                    <h2 class="h2-title">Au plus proche de vos clients</h2>
                    <p class="p-text">Facilitez la vie de vos clients, communiquez de manière facile et rapide et partagez votre passion commune.</p>
                    <ul class="check-text my-4 my-lg-5">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="h2-title">Encaissez vos clients comme vous le souhaitez</h2>
                    <ul class="check-text my-4 my-lg-5">
    ...
    <section class="testimonials" id="testimonials">
        <div class="container">
            <h2 class="h2-title center mb-5">Faites partie du Club !</h2>
